...
describe MogileImage do
  ...
  it{ { :get => '/image/fill200x100/01234567890abcdef01234567890abcdef.png' }.should
    route_to(:controller => 'mogile_images', :size => 'fill200x100', :name => '01234567890abcdef01234567890abcdef', :format => 'png') }
  it{ { :get => '/image/frame200x100/01234567890abcdef01234567890abcdef.png' }.should
    route_to(:controller => 'mogile_images', :size => 'frame200x100', :name => '01234567890abcdef01234567890abcdef', :format => 'png') }
